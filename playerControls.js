...
let fullscreen = document.getElementById("wide");
let mutebtn = document.getElementById("mute");
let container = document.querySelector(".video-player-wrapper");
let controls = document.querySelector(".video-basic button");
...
/*Besides the mute/unmute feature, I think the second most important feature would be the fullscreen toggle.
This is simply because you can get away with other feature from using your mouse: skipping by pressing on
the progress bar, or change volumes on your computer. However, there is no other way to toggle fullscreen without
actually having the button on the media player to do this action.
*/
...
mutebtn.addEventListener("click", () =>{
  ...
  else if(videoElement.muted == true){
